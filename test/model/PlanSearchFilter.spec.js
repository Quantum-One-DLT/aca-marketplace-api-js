...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlanSearchFilter', function() {
      beforeEach(function() {
        instance = new MarketplaceApi.PlanSearchFilter();
      });

      it('should create an instance of PlanSearchFilter', function() {
        // TODO: update the code to test PlanSearchFilter
        expect(instance).to.be.a(MarketplaceApi.PlanSearchFilter);
      });
      ...
      it('should have the property issuers (base name: "issuers")', function() {
        // TODO: update the code to test the property issuers
        expect(instance).to.have.property('issuers');
        // expect(instance.issuers).to.be(expectedValueLiteral);
      });

      it('should have the property metalLevels (base name: "metal_levels")', function() {
        // TODO: update the code to test the property metalLevels
        expect(instance).to.have.property('metalLevels');
        // expect(instance.metalLevels).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property metalDesignTypes (base name: "metal_design_types")', function() {
        // TODO: update the code to test the property metalDesignTypes
        expect(instance).to.have.property('metalDesignTypes');
        // expect(instance.metalDesignTypes).to.be(expectedValueLiteral);
      });

      it('should have the property designTypes (base name: "design_types")', function() {
        // TODO: update the code to test the property designTypes
        expect(instance).to.have.property('designTypes');
        // expect(instance.designTypes).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property deductible (base name: "deductible")', function() {
        // TODO: update the code to test the property deductible
        expect(instance).to.have.property('deductible');
        // expect(instance.deductible).to.be(expectedValueLiteral);
      });

      it('should have the property hsa (base name: "hsa")', function() {
        // TODO: update the code to test the property hsa
        expect(instance).to.have.property('hsa');
        // expect(instance.hsa).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property childDentalCoverage (base name: "child_dental_coverage")', function() {
        // TODO: update the code to test the property childDentalCoverage
        expect(instance).to.have.property('childDentalCoverage');
        // expect(instance.childDentalCoverage).to.be(expectedValueLiteral);
      });

      it('should have the property adultDentalCoverage (base name: "adult_dental_coverage")', function() {
        // TODO: update the code to test the property adultDentalCoverage
        expect(instance).to.have.property('adultDentalCoverage');
        // expect(instance.adultDentalCoverage).to.be(expectedValueLiteral);
      });

      it('should have the property drugs (base name: "drugs")', function() {
        // TODO: update the code to test the property drugs
        expect(instance).to.have.property('drugs');
        // expect(instance.drugs).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property premiumRange (base name: "premium_range")', function() {
        // TODO: update the code to test the property premiumRange
        expect(instance).to.have.property('premiumRange');
        // expect(instance.premiumRange).to.be(expectedValueLiteral);
      });

      it('should have the property deductibleRange (base name: "deductible_range")', function() {
        // TODO: update the code to test the property deductibleRange
        expect(instance).to.have.property('deductibleRange');
        // expect(instance.deductibleRange).to.be(expectedValueLiteral);
      });
