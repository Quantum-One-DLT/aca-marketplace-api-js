...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceApi.ProviderDrugCoverageApi();
  });

  describe('(package)', function() {
    describe('ProviderDrugCoverageApi', function() {
      describe('coverageSearchGet', function() {
        it('should call coverageSearchGet successfully', function(done) {
          // TODO: uncomment, update parameter values for coverageSearchGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var q = "hospital";
          var zipcode = "19123";

          instance.coverageSearchGet(apikey, q, zipcode, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse20016);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.NearbyProvider);
                expect(data.provider).to.be.a(MarketplaceApi.Provider);
                      expect(data.provider.name).to.be.a('string');
                  expect(data.provider.name).to.be("");
                  expect(data.provider.gender).to.be.a(MarketplaceApi.ProviderGenderEnum);
                      {
                    let dataCtr = data.provider.specialties;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                  ...
                  expect(data.provider.type).to.be.a(MarketplaceApi.ProviderTypeEnum);
                      expect(data.provider.accepting).to.be.a('string');
                  expect(data.provider.accepting).to.be("accepting");
                  expect(data.provider.npi).to.be.a('string');
                  expect(data.provider.npi).to.be("");
                  {
                    let dataCtr = data.provider.languages;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                  ...
                  {
                    let dataCtr = data.provider.facilityTypes;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                  ...
                  expect(data.provider.taxonomy).to.be.a('string');
                  expect(data.provider.taxonomy).to.be("");
                expect(data.address).to.be.a(MarketplaceApi.Address);
                  ...
                  expect(data.address.street1).to.be.a('string');
                  expect(data.address.street1).to.be("");
                  ...
                  expect(data.address.countyfips).to.be.a('string');
                  expect(data.address.countyfips).to.be("");
                expect(data.distance).to.be.a('number');
                expect(data.distance).to.be();

                      }
            }
            {
              let dataCtr = data.drugs;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.Drug);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.name).to.be.a('string');
                expect(data.name).to.be("");
                expect(data.rxcui).to.be.a(MarketplaceApi.RxCUI);
                    expect(data.strength).to.be.a('string');
                expect(data.strength).to.be("");
                expect(data.route).to.be.a('string');
                expect(data.route).to.be("");
                expect(data.fullName).to.be.a('string');
                expect(data.fullName).to.be("");
                expect(data.rxtermsDoseForm).to.be.a('string');
                expect(data.rxtermsDoseForm).to.be("");
                expect(data.rxnormDoseForm).to.be.a('string');
                expect(data.rxnormDoseForm).to.be("");
      ...
      describe('coverageStatsGet', function() {
        it('should call coverageStatsGet successfully', function(done) {
          // TODO: uncomment, update parameter values for coverageStatsGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";

          instance.coverageStatsGet(apikey, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse20015);
            expect(data.issuers).to.be.a('number');
            expect(data.issuers).to.be(0);
            expect(data.drugs).to.be.a('number');
            expect(data.drugs).to.be(0);
            expect(data.providers).to.be.a('number');
            expect(data.providers).to.be(0);
            expect(data.providersPlans).to.be.a('number');
            expect(data.providersPlans).to.be(0);
            expect(data.drugsPlans).to.be.a('number');
            expect(data.drugsPlans).to.be(0);
            expect(data.lastRefreshedAt).to.be.a('string');
            expect(data.lastRefreshedAt).to.be("");
      ...
      describe('drugsAutocompleteGet', function() {
        it('should call drugsAutocompleteGet successfully', function(done) {
          // TODO: uncomment, update parameter values for drugsAutocompleteGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var q = "ibuprof";
          var opts = {};
          ...
          instance.drugsAutocompleteGet(apikey, q, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2002);
            {
              let dataCtr = data.drugs;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
      ...
      describe('drugsCoveredGet', function() {
        it('should call drugsCoveredGet successfully', function(done) {
          // TODO: uncomment, update parameter values for drugsCoveredGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var drugs = "1049589";
          var planids = "11512NC0100031";
          var opts = {};
          opts.year = 2019;

          instance.drugsCoveredGet(apikey, drugs, planids, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2004);
            {
              let dataCtr = data.providerDrugCoverage;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.DrugCoverage);
                expect(data.rxcui).to.be.a(MarketplaceApi.RxCUI);
                    expect(data.planId).to.be.a(MarketplaceApi.PlanID);
                    expect(data.coverage).to.be.a(MarketplaceApi.Coverage);
                    expect(data.genericRxcui).to.be.a('string');
                expect(data.genericRxcui).to.be("");
      ...
      describe('drugsSearchGet', function() {
        it('should call drugsSearchGet successfully', function(done) {
          // TODO: uncomment, update parameter values for drugsSearchGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var q = "ibuprofen";
          var opts = {};
          ...
          instance.drugsSearchGet(apikey, q, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2003);
            {
              let dataCtr = data.drugs;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
            ...
            expect(data.prev).to.be.a('string');
            expect(data.prev).to.be("");
      ...
      describe('providersAutocompleteGet', function() {
        it('should call providersAutocompleteGet successfully', function(done) {
          // TODO: uncomment, update parameter values for providersAutocompleteGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var q = "hospital";
          var zipcode = "19123";
          ...
          instance.providersAutocompleteGet(apikey, q, zipcode, type, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('providersCoveredGet', function() {
        it('should call providersCoveredGet successfully', function(done) {
          // TODO: uncomment, update parameter values for providersCoveredGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var providerids = "1407884893";
          var planids = "83761GA0040002";
          var opts = {};
          opts.year = 2019;

          instance.providersCoveredGet(apikey, providerids, planids, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse20018);
            {
              let dataCtr = data.providerDrugCoverage;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.ProviderCoverage);
                expect(data.npi).to.be.a(MarketplaceApi.NPI);
                    expect(data.planId).to.be.a(MarketplaceApi.PlanID);
                    expect(data.coverage).to.be.a(MarketplaceApi.Coverage);
                    {
                  ...
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                    expect(data).to.be.a(MarketplaceApi.Address);
                    expect(data.city).to.be.a('string');
                    expect(data.city).to.be("");
                    expect(data.state).to.be.a('string');
                    expect(data.state).to.be("");
                    expect(data.street1).to.be.a('string');
                    expect(data.street1).to.be("");
                    expect(data.street2).to.be.a('string');
                    expect(data.street2).to.be("");
                    expect(data.zipcode).to.be.a('string');
                    expect(data.zipcode).to.be("");
                    expect(data.countyfips).to.be.a('string');
                    expect(data.countyfips).to.be("");
    
                          }
                }
                expect(data.accepting).to.be.a('string');
                expect(data.accepting).to.be("accepting");
      ...
      describe('providersSearchGet', function() {
        it('should call providersSearchGet successfully', function(done) {
          // TODO: uncomment, update parameter values for providersSearchGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var q = "hospital";
          var zipcode = "19123";
          ...
          var opts = {};
          opts.year = 2019;
          opts.specialty = "specialty_example";

          instance.providersSearchGet(apikey, q, zipcode, type, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse20017);
            expect(data.next).to.be.a('string');
            expect(data.next).to.be("");
            expect(data.prev).to.be.a('string');
            expect(data.prev).to.be("");
