...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceApi.InsuranceIssuersApi();
  });

  describe('(package)', function() {
    describe('InsuranceIssuersApi', function() {
      describe('issuersGet', function() {
        it('should call issuersGet successfully', function(done) {
          // TODO: uncomment, update parameter values for issuersGet call and complete the assertions
          /*
          ...
          instance.issuersGet(apikey, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2007);
            {
              let dataCtr = data.issuers;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.Issuer);
                {
                  let dataCtr = data.eligibleDependents;
                  expect(dataCtr).to.be.an(Array);
                  expect(dataCtr).to.not.be.empty();
                  for (let p in dataCtr) {
                    let data = dataCtr[p];
                ...
                expect(data.individualUrl).to.be.a('string');
                expect(data.individualUrl).to.be("");
                expect(data.name).to.be.a('string');
                expect(data.name).to.be("");
                expect(data.shopUrl).to.be.a('string');
                expect(data.shopUrl).to.be("");
                expect(data.state).to.be.a('string');
                expect(data.state).to.be("");
                expect(data.tollFree).to.be.a('string');
                expect(data.tollFree).to.be("");
                expect(data.tty).to.be.a('string');
                expect(data.tty).to.be("");
      ...
      describe('issuersIssuerIdGet', function() {
        it('should call issuersIssuerIdGet successfully', function(done) {
          // TODO: uncomment, update parameter values for issuersIssuerIdGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var issuerId = "10191";
          var opts = {};
          ...
          instance.issuersIssuerIdGet(apikey, issuerId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2008);
