...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceApi.HouseholdsEligibilityApi();
  });

  describe('(package)', function() {
    describe('HouseholdsEligibilityApi', function() {
      describe('householdsEligibilityEstimatesPost', function() {
        it('should call householdsEligibilityEstimatesPost successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsEligibilityEstimatesPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var estimate = new MarketplaceApi.Estimate();
          estimate.household = new MarketplaceApi.Household();
          estimate.household.income = 0.0;
          estimate.household.unemploymentReceived = "Adult";
          estimate.household.people = [new MarketplaceApi.Person()];
          estimate.household.people[0].age = ;
          estimate.household.people[0].dob = "";
          estimate.household.people[0].hasMec = false;
          estimate.household.people[0].isParent = false;
          estimate.household.people[0].isPregnant = false;
          estimate.household.people[0].pregnantWith = ;
          estimate.household.people[0].usesTobacco = false;
          estimate.household.people[0].lastTobaccoUseDate = "";
          estimate.household.people[0].gender = new MarketplaceApi.GenderEnum();
          estimate.household.people[0].utilizationLevel = new MarketplaceApi.UtilizationEnum();
          estimate.household.people[0].relationship = new MarketplaceApi.Relationship();
          estimate.household.people[0].doesNotCohabitate = false;
          estimate.household.people[0].aptcEligible = false;
          estimate.household.people[0].currentEnrollment = new MarketplaceApi.CurrentEnrollment();
          estimate.household.people[0].currentEnrollment.planId = new MarketplaceApi.PlanID();
          estimate.household.people[0].currentEnrollment.effectiveDate = "";
          estimate.household.people[0].currentEnrollment.usesTobacco = false;
          estimate.household.hasMarriedCouple = false;
          estimate.household.effectiveDate = "";
          estimate.place = new MarketplaceApi.Place();
          estimate.place.countyfips = "";
          estimate.place.state = "";
          estimate.place.zipcode = "";
          estimate.year = ;
          var opts = {};
          opts.year = 2019;

          instance.householdsEligibilityEstimatesPost(apikey, estimate, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2005);
            {
              let dataCtr = data.estimates;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(MarketplaceApi.Eligibility);
                expect(data.aptc).to.be.a('number');
                expect(data.aptc).to.be(0.0);
                expect(data.csr).to.be.a(MarketplaceApi.CSREligibilityEnum);
                    expect(data.hardshipExemption).to.be.a('boolean');
                expect(data.hardshipExemption).to.be(false);
                expect(data.isMedicaidChip).to.be.a('boolean');
                expect(data.isMedicaidChip).to.be(false);
      ...
      describe('householdsIchraPost', function() {
        it('should call householdsIchraPost successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsIchraPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var ichra = new MarketplaceApi.Ichra();
          ichra.household = new MarketplaceApi.LowestCostPlanHousehold();
          ichra.household.income = 0.0;
          ichra.household.people = [new MarketplaceApi.LowestCostPlanPerson()];
          ichra.household.people[0].age = ;
          ichra.household.people[0].usesTobacco = false;
          ichra.place = new MarketplaceApi.Place();
          ichra.place.countyfips = "";
          ichra.place.state = "";
          ichra.place.zipcode = "";
          ichra.year = ;
          ichra.hra = 0.0;
          ...
          instance.householdsIchraPost(apikey, ichra, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.ICHRAResponse);
            expect(data.affordable).to.be.a('boolean');
            expect(data.affordable).to.be(false);
            expect(data.premium).to.be.a('number');
            expect(data.premium).to.be();
      ...
      describe('householdsLcbpPost', function() {
        it('should call householdsLcbpPost successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsLcbpPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var lcbp = new MarketplaceApi.Lcbp();
          lcbp.household = new MarketplaceApi.LowestCostPlanHousehold();
          lcbp.household.income = 0.0;
          lcbp.household.people = [new MarketplaceApi.LowestCostPlanPerson()];
          lcbp.household.people[0].age = ;
          lcbp.household.people[0].usesTobacco = false;
          lcbp.place = new MarketplaceApi.Place();
          lcbp.place.countyfips = "";
          lcbp.place.state = "";
          lcbp.place.zipcode = "";
          lcbp.year = ;
          var opts = {};
          ...
          instance.householdsLcbpPost(apikey, lcbp, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.LowestCostPlanResponse);
      ...
      describe('householdsLcspPost', function() {
        it('should call householdsLcspPost successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsLcspPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var lcsp = new MarketplaceApi.Lcsp();
          lcsp.household = new MarketplaceApi.LowestCostPlanHousehold();
          lcsp.household.income = 0.0;
          lcsp.household.people = [new MarketplaceApi.LowestCostPlanPerson()];
          lcsp.household.people[0].age = ;
          lcsp.household.people[0].usesTobacco = false;
          lcsp.place = new MarketplaceApi.Place();
          lcsp.place.countyfips = "";
          lcsp.place.state = "";
          lcsp.place.zipcode = "";
          lcsp.year = ;
          var opts = {};
          ...
          instance.householdsLcspPost(apikey, lcsp, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('householdsPcfplGet', function() {
        it('should call householdsPcfplGet successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsPcfplGet call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var year = 2019;
          var state = "VA";
          ...
          instance.householdsPcfplGet(apikey, year, state, size, income, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse2006);
      ...
      describe('householdsSlcspPost', function() {
        it('should call householdsSlcspPost successfully', function(done) {
          // TODO: uncomment, update parameter values for householdsSlcspPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var slcsp = new MarketplaceApi.Slcsp();
          slcsp.household = new MarketplaceApi.LowestCostPlanHousehold();
          slcsp.household.income = 0.0;
          slcsp.household.people = [new MarketplaceApi.LowestCostPlanPerson()];
          slcsp.household.people[0].age = ;
          slcsp.household.people[0].usesTobacco = false;
          slcsp.place = new MarketplaceApi.Place();
          slcsp.place.countyfips = "";
          slcsp.place.state = "";
          slcsp.place.zipcode = "";
          slcsp.year = ;
          var opts = {};
          ...
          instance.householdsSlcspPost(apikey, slcsp, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
