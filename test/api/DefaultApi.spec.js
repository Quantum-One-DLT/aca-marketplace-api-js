...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MarketplaceApi.DefaultApi();
  });

  describe('(package)', function() {
    describe('DefaultApi', function() {
      describe('plansPlanIdPost', function() {
        it('should call plansPlanIdPost successfully', function(done) {
          // TODO: uncomment, update parameter values for plansPlanIdPost call and complete the assertions
          /*
          var apikey = "d687412e7b53146b2631dc01974ad0a4";
          var planId = "11512NC0100031";
          var request = new MarketplaceApi.Request1();
          ...
          instance.plansPlanIdPost(apikey, planId, request, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MarketplaceApi.InlineResponse20013);
