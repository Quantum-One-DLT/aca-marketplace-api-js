...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Relationship'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Relationship'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Issuer = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Relationship);
  }
}(this, function(ApiClient, Relationship) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('eligible_dependents'))
        obj.eligibleDependents = ApiClient.convertToType(data['eligible_dependents'], [Relationship]);
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'String');
      if (data.hasOwnProperty('individual_url'))
        obj.individualUrl = ApiClient.convertToType(data['individual_url'], 'String');
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('shop_url'))
        obj.shopUrl = ApiClient.convertToType(data['shop_url'], 'String');
      if (data.hasOwnProperty('state'))
        obj.state = ApiClient.convertToType(data['state'], 'String');
      if (data.hasOwnProperty('toll_free'))
        obj.tollFree = ApiClient.convertToType(data['toll_free'], 'String');
   ...
   * @member {Array.<module:model/Relationship>} eligibleDependents
   */
  exports.prototype.eligibleDependents = undefined;
  ...
  /**
   * URL for individual market plans
   * @member {String} individualUrl
   */
  exports.prototype.individualUrl = undefined;
   ...
   */
  exports.prototype.shopUrl = undefined;
