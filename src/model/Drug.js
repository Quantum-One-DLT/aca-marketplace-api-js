...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RxCUI'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RxCUI'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Drug = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.RxCUI);
  }
}(this, function(ApiClient, RxCUI) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rxcui'))
        obj.rxcui = RxCUI.constructFromObject(data['rxcui']);
      ...
      if (data.hasOwnProperty('rxterms_dose_form'))
        obj.rxtermsDoseForm = ApiClient.convertToType(data['rxterms_dose_form'], 'String');
      if (data.hasOwnProperty('rxnorm_dose_form'))
        obj.rxnormDoseForm = ApiClient.convertToType(data['rxnorm_dose_form'], 'String');
    }
    return obj;
  }
  ...
  /**
   * normalized SAB=RXNORM name
   * @member {String} name
   */
  exports.prototype.name = undefined;

  /**
   * @member {module:model/RxCUI} rxcui
   */
  exports.prototype.rxcui = undefined;

  /**
   * strength information for this drug
   * @member {String} strength
   */
  exports.prototype.strength = undefined;

  /**
   * route information for this drug
   * @member {String} route
   */
  exports.prototype.route = undefined;

  /**
   * full name information for this drug
   * @member {String} fullName
   */
  exports.prototype.fullName = undefined;

  /**
   * rxtermsDoseForm value for this drug
   * @member {String} rxtermsDoseForm
   */
  exports.prototype.rxtermsDoseForm = undefined;

  /**
   * rxnormDoseForm for this drug
   * @member {String} rxnormDoseForm
   */
  exports.prototype.rxnormDoseForm = undefined;
