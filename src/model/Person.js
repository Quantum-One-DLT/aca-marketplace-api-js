...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrentEnrollment', 'model/GenderEnum', 'model/Relationship', 'model/UtilizationEnum'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrentEnrollment'), require('./GenderEnum'), require('./Relationship'), require('./UtilizationEnum'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Person = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.CurrentEnrollment, root.MarketplaceApi.GenderEnum, root.MarketplaceApi.Relationship, root.MarketplaceApi.UtilizationEnum);
  }
}(this, function(ApiClient, CurrentEnrollment, GenderEnum, Relationship, UtilizationEnum) {
  'use strict';
   ...
   * @class
   * @param age {Number} required if dob not provided
   * @param dob {String} A person's date of birth (YYYY-MM-DD) required if age not provided
   */
  var exports = function(age, dob) {
    this.age = age;
    this.dob = dob;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('has_mec'))
        obj.hasMec = ApiClient.convertToType(data['has_mec'], 'Boolean');
      if (data.hasOwnProperty('is_parent'))
        obj.isParent = ApiClient.convertToType(data['is_parent'], 'Boolean');
      if (data.hasOwnProperty('is_pregnant'))
        obj.isPregnant = ApiClient.convertToType(data['is_pregnant'], 'Boolean');
      if (data.hasOwnProperty('pregnant_with'))
        obj.pregnantWith = ApiClient.convertToType(data['pregnant_with'], 'Number');
      if (data.hasOwnProperty('uses_tobacco'))
        obj.usesTobacco = ApiClient.convertToType(data['uses_tobacco'], 'Boolean');
      if (data.hasOwnProperty('last_tobacco_use_date'))
        obj.lastTobaccoUseDate = ApiClient.convertToType(data['last_tobacco_use_date'], 'String');
      if (data.hasOwnProperty('gender'))
        obj.gender = GenderEnum.constructFromObject(data['gender']);
      if (data.hasOwnProperty('utilization_level'))
        obj.utilizationLevel = UtilizationEnum.constructFromObject(data['utilization_level']);
      if (data.hasOwnProperty('relationship'))
        obj.relationship = Relationship.constructFromObject(data['relationship']);
      if (data.hasOwnProperty('does_not_cohabitate'))
        obj.doesNotCohabitate = ApiClient.convertToType(data['does_not_cohabitate'], 'Boolean');
      if (data.hasOwnProperty('aptc_eligible'))
        obj.aptcEligible = ApiClient.convertToType(data['aptc_eligible'], 'Boolean');
  ...
  /**
   * required if dob not provided
   * @member {Number} age
   */
  exports.prototype.age = undefined;

  /**
   * A person's date of birth (YYYY-MM-DD) required if age not provided
   * @member {String} dob
   */
   ...
   * @member {Boolean} hasMec
   */
  exports.prototype.hasMec = undefined;

  /**
   * @member {Boolean} isParent
   */
  exports.prototype.isParent = undefined;
   ...
   * @member {Boolean} isPregnant
   */
  exports.prototype.isPregnant = undefined;
   ...
   * @member {Number} pregnantWith
   */
  exports.prototype.pregnantWith = undefined;

  /**
   * @member {Boolean} usesTobacco
   */
  exports.prototype.usesTobacco = undefined;

  /**
   * The last date of regular tobacco use (YYYY-MM-DD)
   * @member {String} lastTobaccoUseDate
   */
  exports.prototype.lastTobaccoUseDate = undefined;
  ...
  /**
   * @member {module:model/UtilizationEnum} utilizationLevel
   */
  exports.prototype.utilizationLevel = undefined;
  ...
  /**
   * @member {Boolean} doesNotCohabitate
   */
  exports.prototype.doesNotCohabitate = undefined;

  /**
   * is the given person eligible for APTC
   * @member {Boolean} aptcEligible
   */
  exports.prototype.aptcEligible = undefined;
