...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CSRRequestEnum', 'model/Household', 'model/MarketEnum', 'model/Place', 'model/PlanIDList', 'model/PlanSearchFilter'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CSRRequestEnum'), require('./Household'), require('./MarketEnum'), require('./Place'), require('./PlanIDList'), require('./PlanSearchFilter'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.PlanSearchRequest = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.CSRRequestEnum, root.MarketplaceApi.Household, root.MarketplaceApi.MarketEnum, root.MarketplaceApi.Place, root.MarketplaceApi.PlanIDList, root.MarketplaceApi.PlanSearchFilter);
  }
}(this, function(ApiClient, CSRRequestEnum, Household, MarketEnum, Place, PlanIDList, PlanSearchFilter) {
  'use strict';

  /**
   * The PlanSearchRequest model module.
   * @module model/PlanSearchRequest
   * @version 1
   */

  /**
   * Constructs a new <code>PlanSearchRequest</code>.
   * @alias module:model/PlanSearchRequest
   * @class
   * @param place {module:model/Place} 
   * @param market {module:model/MarketEnum} 
   */
  var exports = function(place, market) {
    this.place = place;
    this.market = market;
  };

  /**
   * Constructs a <code>PlanSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PlanSearchRequest} obj Optional instance to populate.
   * @return {module:model/PlanSearchRequest} The populated <code>PlanSearchRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('filter'))
        obj.filter = PlanSearchFilter.constructFromObject(data['filter']);
      ...
      if (data.hasOwnProperty('aptc_override'))
        obj.aptcOverride = ApiClient.convertToType(data['aptc_override'], 'Number');
      if (data.hasOwnProperty('csr_override'))
        obj.csrOverride = CSRRequestEnum.constructFromObject(data['csr_override']);
      if (data.hasOwnProperty('catastrophic_override'))
        obj.catastrophicOverride = ApiClient.convertToType(data['catastrophic_override'], 'Boolean');
      if (data.hasOwnProperty('suppressed_plan_ids'))
        obj.suppressedPlanIds = PlanIDList.constructFromObject(data['suppressed_plan_ids']);
    }
    return obj;
  }

  /**
   * @member {module:model/PlanSearchFilter} filter
   */
  ...
  /**
   * @member {module:model/PlanSearchRequest.OrderEnum} order
   */
  ...
  /**
   * @member {module:model/PlanSearchRequest.SortEnum} sort
   */
  exports.prototype.sort = undefined;

  /**
   * defaults to current open enrollment year
   * @member {Number} year
   */
   ...
   * @member {Number} aptcOverride
   */
  exports.prototype.aptcOverride = undefined;

  /**
   * @member {module:model/CSRRequestEnum} csrOverride
   */
  exports.prototype.csrOverride = undefined;

  /**
   * Force the display (or suppression) of catastrophic plans
   * @member {Boolean} catastrophicOverride
   */
  exports.prototype.catastrophicOverride = undefined;

  /**
   * @member {module:model/PlanIDList} suppressedPlanIds
   */
  exports.prototype.suppressedPlanIds = undefined;
