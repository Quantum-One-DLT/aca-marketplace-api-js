...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProviderGenderEnum', 'model/ProviderTypeEnum'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProviderGenderEnum'), require('./ProviderTypeEnum'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Provider = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.ProviderGenderEnum, root.MarketplaceApi.ProviderTypeEnum);
  }
}(this, function(ApiClient, ProviderGenderEnum, ProviderTypeEnum) {
  'use strict';
   ...
   * @class
   * @param name {String} 
   * @param type {module:model/ProviderTypeEnum} 
   * @param npi {String} 
   */
  var exports = function(name, type, npi) {
    this.name = name;
    this.type = type;
    this.npi = npi;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('gender'))
        obj.gender = ProviderGenderEnum.constructFromObject(data['gender']);
      if (data.hasOwnProperty('specialties'))
        obj.specialties = ApiClient.convertToType(data['specialties'], ['String']);
      if (data.hasOwnProperty('type'))
        obj.type = ProviderTypeEnum.constructFromObject(data['type']);
      ...
      if (data.hasOwnProperty('facility_types'))
        obj.facilityTypes = ApiClient.convertToType(data['facility_types'], ['String']);
  ...
  /**
   * @member {module:model/ProviderGenderEnum} gender
   */
   ...
   */
  exports.prototype.specialties = undefined;

  /**
   * @member {module:model/ProviderTypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/Provider.AcceptingEnum} accepting
   */
   ...
   * @member {Array.<String>} facilityTypes
   */
  exports.prototype.facilityTypes = undefined;
