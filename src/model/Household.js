...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MarketplaceApi.Household = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Person);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('unemployment_received'))
        obj.unemploymentReceived = ApiClient.convertToType(data['unemployment_received'], 'String');
      if (data.hasOwnProperty('people'))
        obj.people = ApiClient.convertToType(data['people'], [Person]);
      if (data.hasOwnProperty('has_married_couple'))
        obj.hasMarriedCouple = ApiClient.convertToType(data['has_married_couple'], 'Boolean');
      if (data.hasOwnProperty('effective_date'))
        obj.effectiveDate = ApiClient.convertToType(data['effective_date'], 'String');
    }
    return obj;
  }

  /**
   * household's yearly income in dollars
   * @member {Number} income
   */
  exports.prototype.income = undefined;

  /**
   * Specifies whether a tax payer or tax dependent in the household received unemployment benefits for market year 2021. May affect ATPC and CSR calulations due to income percentage capping if income is above 133% of the Federal poverty level. If the person who received unemployment is a tax dependent, only the eligible CSRs will be affected. Defaults to None
   * @member {module:model/Household.UnemploymentReceivedEnum} unemploymentReceived
   */
  exports.prototype.unemploymentReceived = undefined;
  ...
  /**
   * @member {Boolean} hasMarriedCouple
   */
  exports.prototype.hasMarriedCouple = undefined;

  /**
   * The effective date of the application (YYYY-MM-DD)
  ...
  /**
   * Allowed values for the <code>unemploymentReceived</code> property.
   * @enum {String}
   * @readonly
   */
  exports.UnemploymentReceivedEnum = {
    /**
     * value: "Adult"
     * @const
     */
