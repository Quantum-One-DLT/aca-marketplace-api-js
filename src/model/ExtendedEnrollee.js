...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/CostSharingReductionEnum', 'model/CurrentEnrollment', 'model/GenderEnum', 'model/MetalLevelEnum', 'model/PlanID', 'model/Relationship'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Address'), require('./CostSharingReductionEnum'), require('./CurrentEnrollment'), require('./GenderEnum'), require('./MetalLevelEnum'), require('./PlanID'), require('./Relationship'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.ExtendedEnrollee = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Address, root.MarketplaceApi.CostSharingReductionEnum, root.MarketplaceApi.CurrentEnrollment, root.MarketplaceApi.GenderEnum, root.MarketplaceApi.MetalLevelEnum, root.MarketplaceApi.PlanID, root.MarketplaceApi.Relationship);
  }
}(this, function(ApiClient, Address, CostSharingReductionEnum, CurrentEnrollment, GenderEnum, MetalLevelEnum, PlanID, Relationship) {
  'use strict';

  /**
   * The ExtendedEnrollee model module.
   * @module model/ExtendedEnrollee
   * @version 1
   */

  /**
   * Constructs a new <code>ExtendedEnrollee</code>.
   * @alias module:model/ExtendedEnrollee
   * @class
   */
  ...
  /**
   * Constructs a <code>ExtendedEnrollee</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExtendedEnrollee} obj Optional instance to populate.
   * @return {module:model/ExtendedEnrollee} The populated <code>ExtendedEnrollee</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('gender'))
        obj.gender = GenderEnum.constructFromObject(data['gender']);
      if (data.hasOwnProperty('dob'))
        obj.dob = ApiClient.convertToType(data['dob'], 'String');
      if (data.hasOwnProperty('location'))
        obj.location = Address.constructFromObject(data['location']);
      if (data.hasOwnProperty('csr'))
        obj.csr = CostSharingReductionEnum.constructFromObject(data['csr']);
      if (data.hasOwnProperty('is_filer'))
        obj.isFiler = ApiClient.convertToType(data['is_filer'], 'Boolean');
      if (data.hasOwnProperty('effective_age'))
        obj.effectiveAge = ApiClient.convertToType(data['effective_age'], 'Number');
      if (data.hasOwnProperty('has_hardship'))
        obj.hasHardship = ApiClient.convertToType(data['has_hardship'], 'Boolean');
      if (data.hasOwnProperty('relationship'))
        obj.relationship = Relationship.constructFromObject(data['relationship']);
      if (data.hasOwnProperty('allowed_metal_levels'))
        obj.allowedMetalLevels = ApiClient.convertToType(data['allowed_metal_levels'], [MetalLevelEnum]);
      if (data.hasOwnProperty('allowed_plan_ids'))
        obj.allowedPlanIds = ApiClient.convertToType(data['allowed_plan_ids'], [PlanID]);
      if (data.hasOwnProperty('current_enrollment'))
        obj.currentEnrollment = CurrentEnrollment.constructFromObject(data['current_enrollment']);
    }
    return obj;
  }

  /**
   * The enrollee's id (uuid)
   * @member {String} id
   */
  ...
  /**
   * The enrollee's date of birth (iso8601 date)
   * @member {String} dob
   */
  exports.prototype.dob = undefined;

  /**
   * @member {module:model/Address} location
   */
  exports.prototype.location = undefined;

  /**
   * @member {module:model/CostSharingReductionEnum} csr
   */
  exports.prototype.csr = undefined;

  /**
   * @member {Boolean} isFiler
   */
  exports.prototype.isFiler = undefined;

  /**
   * Effective age of the enrollee at time of enrollment.
   * @member {Number} effectiveAge
   */
  exports.prototype.effectiveAge = undefined;

  /**
   * @member {Boolean} hasHardship
   */
  exports.prototype.hasHardship = undefined;

  /**
   * @member {module:model/Relationship} relationship
   */
  exports.prototype.relationship = undefined;

  /**
   * @member {Array.<module:model/MetalLevelEnum>} allowedMetalLevels
   */
  exports.prototype.allowedMetalLevels = undefined;

  /**
   * @member {Array.<module:model/PlanID>} allowedPlanIds
   */
  exports.prototype.allowedPlanIds = undefined;

  /**
   * @member {module:model/CurrentEnrollment} currentEnrollment
   */
