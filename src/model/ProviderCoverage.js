...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Address', 'model/Coverage', 'model/NPI', 'model/PlanID'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Address'), require('./Coverage'), require('./NPI'), require('./PlanID'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.ProviderCoverage = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Address, root.MarketplaceApi.Coverage, root.MarketplaceApi.NPI, root.MarketplaceApi.PlanID);
  }
}(this, function(ApiClient, Address, Coverage, NPI, PlanID) {
  'use strict';

  /**
   * The ProviderCoverage model module.
   * @module model/ProviderCoverage
   * @version 1
   */

  /**
   * Constructs a new <code>ProviderCoverage</code>.
   * @alias module:model/ProviderCoverage
   * @class
   */
  ...
  /**
   * Constructs a <code>ProviderCoverage</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProviderCoverage} obj Optional instance to populate.
   * @return {module:model/ProviderCoverage} The populated <code>ProviderCoverage</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('npi'))
        obj.npi = NPI.constructFromObject(data['npi']);
      if (data.hasOwnProperty('plan_id'))
        obj.planId = PlanID.constructFromObject(data['plan_id']);
      ...
      if (data.hasOwnProperty('accepting'))
        obj.accepting = ApiClient.convertToType(data['accepting'], 'String');
    }
    return obj;
  }

  /**
   * @member {module:model/NPI} npi
   */
  exports.prototype.npi = undefined;

  /**
   * @member {module:model/PlanID} planId
   */
  ...
  /**
   * at which addresses this provider is covered by the plan, if any
   * @member {Array.<module:model/Address>} addresses
   */
  exports.prototype.addresses = undefined;

  /**
   * @member {module:model/ProviderCoverage.AcceptingEnum} accepting
   */
  exports.prototype.accepting = undefined;



  /**
   * Allowed values for the <code>accepting</code> property.
   * @enum {String}
   * @readonly
   */
  exports.AcceptingEnum = {
    /**
     * value: "accepting"
     * @const
     */
    ...
    /**
     * value: "accepting in some locations"
     * @const
     */
    acceptingInSomeLocations: "accepting in some locations",
