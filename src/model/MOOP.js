...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CostSharingReductionEnum', 'model/NetworkTierEnum'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CostSharingReductionEnum'), require('./NetworkTierEnum'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.MOOP = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.CostSharingReductionEnum, root.MarketplaceApi.NetworkTierEnum);
  }
}(this, function(ApiClient, CostSharingReductionEnum, NetworkTierEnum) {
  'use strict';

  /**
   * The MOOP model module.
   * @module model/MOOP
   * @version 1
   */

  /**
   * Constructs a new <code>MOOP</code>.
   * maximum out-of-pocket
   * @alias module:model/MOOP
   * @class
   */
  ...
  /**
   * Constructs a <code>MOOP</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MOOP} obj Optional instance to populate.
   * @return {module:model/MOOP} The populated <code>MOOP</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('family_cost'))
        obj.familyCost = ApiClient.convertToType(data['family_cost'], 'String');
      if (data.hasOwnProperty('network_tier'))
        obj.networkTier = NetworkTierEnum.constructFromObject(data['network_tier']);
      if (data.hasOwnProperty('type'))
        obj.type = ApiClient.convertToType(data['type'], 'String');
      if (data.hasOwnProperty('individual'))
        obj.individual = ApiClient.convertToType(data['individual'], 'Boolean');
      if (data.hasOwnProperty('family'))
        obj.family = ApiClient.convertToType(data['family'], 'Boolean');
      if (data.hasOwnProperty('display_string'))
        obj.displayString = ApiClient.convertToType(data['display_string'], 'String');
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/MOOP.FamilyCostEnum} familyCost
   */
  exports.prototype.familyCost = undefined;

  /**
   * @member {module:model/NetworkTierEnum} networkTier
   */
  exports.prototype.networkTier = undefined;

  /**
   * @member {module:model/MOOP.TypeEnum} type
   */
   ...
   */
  exports.prototype.individual = undefined;

  /**
   * Applies to families
   * @member {Boolean} family
   */
  ...
  /**
   * Allowed values for the <code>familyCost</code> property.
   * @enum {String}
   * @readonly
   */
  exports.FamilyCostEnum = {
    /**
     * value: "Individual"
     * @const
     */
    ...
    /**
     * value: "Family Per Person"
     * @const
     */
    familyPerPerson: "Family Per Person"
  };
  ...
  exports.TypeEnum = {
    /**
     * value: "Maximum Out of Pocket for Medical and Drug EHB Benefits (Total)"
     * @const
     */
    medicalAndDrugEHBBenefitsTotal: "Maximum Out of Pocket for Medical and Drug EHB Benefits (Total)",

    /**
     * value: "Maximum Out of Pocket for Medical EHB Benefits"
     * @const
     */
    medicalEHBBenefits: "Maximum Out of Pocket for Medical EHB Benefits",

    /**
     * value: "Maximum Out of Pocket for Drug EHB Benefits"
     * @const
     */
    drugEHBBenefits: "Maximum Out of Pocket for Drug EHB Benefits"
  };
