...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Benefit', 'model/CertificationStatus', 'model/Deductible', 'model/DiseaseMgmtProgramsEnum', 'model/InsuranceMarketEnum', 'model/Issuer', 'model/MOOP', 'model/MarketEnum', 'model/MetalLevelEnum', 'model/PlanNetworkAdequacy', 'model/PlanSbcs', 'model/PlanTypeEnum', 'model/ProductDivisionEnum', 'model/QualityRating', 'model/SuppressionStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Benefit'), require('./CertificationStatus'), require('./Deductible'), require('./DiseaseMgmtProgramsEnum'), require('./InsuranceMarketEnum'), require('./Issuer'), require('./MOOP'), require('./MarketEnum'), require('./MetalLevelEnum'), require('./PlanNetworkAdequacy'), require('./PlanSbcs'), require('./PlanTypeEnum'), require('./ProductDivisionEnum'), require('./QualityRating'), require('./SuppressionStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Plan = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Benefit, root.MarketplaceApi.CertificationStatus, root.MarketplaceApi.Deductible, root.MarketplaceApi.DiseaseMgmtProgramsEnum, root.MarketplaceApi.InsuranceMarketEnum, root.MarketplaceApi.Issuer, root.MarketplaceApi.MOOP, root.MarketplaceApi.MarketEnum, root.MarketplaceApi.MetalLevelEnum, root.MarketplaceApi.PlanNetworkAdequacy, root.MarketplaceApi.PlanSbcs, root.MarketplaceApi.PlanTypeEnum, root.MarketplaceApi.ProductDivisionEnum, root.MarketplaceApi.QualityRating, root.MarketplaceApi.SuppressionStatus);
  }
}(this, function(ApiClient, Benefit, CertificationStatus, Deductible, DiseaseMgmtProgramsEnum, InsuranceMarketEnum, Issuer, MOOP, MarketEnum, MetalLevelEnum, PlanNetworkAdequacy, PlanSbcs, PlanTypeEnum, ProductDivisionEnum, QualityRating, SuppressionStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('benefits'))
        obj.benefits = ApiClient.convertToType(data['benefits'], [Benefit]);
      if (data.hasOwnProperty('deductibles'))
        obj.deductibles = ApiClient.convertToType(data['deductibles'], [Deductible]);
      ...
      if (data.hasOwnProperty('has_national_network'))
        obj.hasNationalNetwork = ApiClient.convertToType(data['has_national_network'], 'Boolean');
      if (data.hasOwnProperty('quality_rating'))
        obj.qualityRating = QualityRating.constructFromObject(data['quality_rating']);
      if (data.hasOwnProperty('insurance_market'))
        obj.insuranceMarket = InsuranceMarketEnum.constructFromObject(data['insurance_market']);
      if (data.hasOwnProperty('issuer'))
        obj.issuer = Issuer.constructFromObject(data['issuer']);
      if (data.hasOwnProperty('market'))
        obj.market = MarketEnum.constructFromObject(data['market']);
      if (data.hasOwnProperty('max_age_child'))
        obj.maxAgeChild = ApiClient.convertToType(data['max_age_child'], 'Number');
      if (data.hasOwnProperty('metal_level'))
        obj.metalLevel = MetalLevelEnum.constructFromObject(data['metal_level']);
      if (data.hasOwnProperty('moops'))
        obj.moops = ApiClient.convertToType(data['moops'], [MOOP]);
      if (data.hasOwnProperty('premium'))
        obj.premium = ApiClient.convertToType(data['premium'], 'Number');
      if (data.hasOwnProperty('premium_w_credit'))
        obj.premiumWCredit = ApiClient.convertToType(data['premium_w_credit'], 'Number');
      if (data.hasOwnProperty('ehb_premium'))
        obj.ehbPremium = ApiClient.convertToType(data['ehb_premium'], 'Number');
      if (data.hasOwnProperty('pediatric_ehb_premium'))
        obj.pediatricEhbPremium = ApiClient.convertToType(data['pediatric_ehb_premium'], 'Number');
      if (data.hasOwnProperty('aptc_eligible_premium'))
        obj.aptcEligiblePremium = ApiClient.convertToType(data['aptc_eligible_premium'], 'Number');
      if (data.hasOwnProperty('guaranteed_rate'))
        obj.guaranteedRate = ApiClient.convertToType(data['guaranteed_rate'], 'Boolean');
      if (data.hasOwnProperty('simple_choice'))
        obj.simpleChoice = ApiClient.convertToType(data['simple_choice'], 'Boolean');
      if (data.hasOwnProperty('product_division'))
        obj.productDivision = ProductDivisionEnum.constructFromObject(data['product_division']);
      if (data.hasOwnProperty('specialist_referral_required'))
        obj.specialistReferralRequired = ApiClient.convertToType(data['specialist_referral_required'], 'Boolean');
      if (data.hasOwnProperty('state'))
        obj.state = ApiClient.convertToType(data['state'], 'String');
      if (data.hasOwnProperty('type'))
        obj.type = PlanTypeEnum.constructFromObject(data['type']);
      if (data.hasOwnProperty('benefits_url'))
        obj.benefitsUrl = ApiClient.convertToType(data['benefits_url'], 'String');
      if (data.hasOwnProperty('brochure_url'))
        obj.brochureUrl = ApiClient.convertToType(data['brochure_url'], 'String');
      if (data.hasOwnProperty('formulary_url'))
        obj.formularyUrl = ApiClient.convertToType(data['formulary_url'], 'String');
      if (data.hasOwnProperty('network_url'))
        obj.networkUrl = ApiClient.convertToType(data['network_url'], 'String');
      if (data.hasOwnProperty('hsa_eligible'))
        obj.hsaEligible = ApiClient.convertToType(data['hsa_eligible'], 'Boolean');
      if (data.hasOwnProperty('oopc'))
        obj.oopc = ApiClient.convertToType(data['oopc'], 'Number');
      if (data.hasOwnProperty('suppression_state'))
        obj.suppressionState = SuppressionStatus.constructFromObject(data['suppression_state']);
      if (data.hasOwnProperty('tobacco_lookback'))
        obj.tobaccoLookback = ApiClient.convertToType(data['tobacco_lookback'], 'Number');
      if (data.hasOwnProperty('certification'))
        obj.certification = CertificationStatus.constructFromObject(data['certification']);
      if (data.hasOwnProperty('network_adequacy'))
        obj.networkAdequacy = PlanNetworkAdequacy.constructFromObject(data['network_adequacy']);
      if (data.hasOwnProperty('sbcs'))
        obj.sbcs = PlanSbcs.constructFromObject(data['sbcs']);
      if (data.hasOwnProperty('rx_3mo_mail_order'))
        obj.rx3moMailOrder = ApiClient.convertToType(data['rx_3mo_mail_order'], 'Boolean');
      if (data.hasOwnProperty('is_ineligible'))
        obj.isIneligible = ApiClient.convertToType(data['is_ineligible'], 'Boolean');
      if (data.hasOwnProperty('covers_nonhyde_abortion'))
        obj.coversNonhydeAbortion = ApiClient.convertToType(data['covers_nonhyde_abortion'], 'Boolean');
      if (data.hasOwnProperty('service_area_id'))
        obj.serviceAreaId = ApiClient.convertToType(data['service_area_id'], 'String');
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Benefit>} benefits
   */
  exports.prototype.benefits = undefined;

  /**
   * @member {Array.<module:model/Deductible>} deductibles
   */
  exports.prototype.deductibles = undefined;
   ...
   * @member {Boolean} hasNationalNetwork
   */
  exports.prototype.hasNationalNetwork = undefined;

  /**
   * @member {module:model/QualityRating} qualityRating
   */
  exports.prototype.qualityRating = undefined;

  /**
   * @member {module:model/InsuranceMarketEnum} insuranceMarket
   */
  exports.prototype.insuranceMarket = undefined;
  ...
  /**
   * @member {module:model/MarketEnum} market
   */
  exports.prototype.market = undefined;

  /**
   * the maximum age a person is considered a child on their parents' plan
   * @member {Number} maxAgeChild
   */
  exports.prototype.maxAgeChild = undefined;
  ...
  /**
   * @member {Array.<module:model/MOOP>} moops
   */
  exports.prototype.moops = undefined;

  /**
   * monthly premium in US dollars, unsubsidized (i.e., no APTC applied)
   * @member {Number} premium
   */
  exports.prototype.premium = undefined;

  /**
   * monthly premium in US dollars, with APTC applied
   * @member {Number} premiumWCredit
   */
  exports.prototype.premiumWCredit = undefined;

  /**
   * monthly premium in US dollars, for essential health benefits portion of total premium
   * @member {Number} ehbPremium
   */
  exports.prototype.ehbPremium = undefined;

  /**
   * monthly pediatric portion of the ehb premium in US dollars
   * @member {Number} pediatricEhbPremium
   */
  exports.prototype.pediatricEhbPremium = undefined;

  /**
   * the portion of the premium that is eligible for APTC
   * @member {Number} aptcEligiblePremium
   */
  exports.prototype.aptcEligiblePremium = undefined;

  /**
   * true if the premiums are guaranteed (versus estimated)
   * @member {Boolean} guaranteedRate
   */
  exports.prototype.guaranteedRate = undefined;
  ...
  /**
   * @member {module:model/ProductDivisionEnum} productDivision
   */
  exports.prototype.productDivision = undefined;

  /**
   * @member {Boolean} specialistReferralRequired
   */
  exports.prototype.specialistReferralRequired = undefined;
  ...
  /**
   * @member {String} benefitsUrl
   */
  exports.prototype.benefitsUrl = undefined;

  /**
   * @member {String} brochureUrl
   */
  exports.prototype.brochureUrl = undefined;

  /**
   * @member {String} formularyUrl
   */
  exports.prototype.formularyUrl = undefined;
   ...
   * @member {Boolean} hsaEligible
   */
  exports.prototype.hsaEligible = undefined;
  ...
  /**
   * @member {module:model/SuppressionStatus} suppressionState
   */
  exports.prototype.suppressionState = undefined;

  /**
   * @member {Number} tobaccoLookback
   */
  exports.prototype.tobaccoLookback = undefined;

  /**
   * @member {module:model/CertificationStatus} certification
   */
  exports.prototype.certification = undefined;

  /**
   * @member {module:model/PlanNetworkAdequacy} networkAdequacy
   */
  exports.prototype.networkAdequacy = undefined;

  /**
   * @member {module:model/PlanSbcs} sbcs
   */
  exports.prototype.sbcs = undefined;

  /**
   * 3-month in-network mail order pharmacy benefit
   * @member {Boolean} rx3moMailOrder
   */
  exports.prototype.rx3moMailOrder = undefined;

  /**
   * If the given enrollment group/household is ineligible for the plan by business rules, it will be flagged true
   * @member {Boolean} isIneligible
   */
  exports.prototype.isIneligible = undefined;

  /**
   * @member {Boolean} coversNonhydeAbortion
   */
  exports.prototype.coversNonhydeAbortion = undefined;
   ...
   * @member {String} serviceAreaId
   */
  exports.prototype.serviceAreaId = undefined;
