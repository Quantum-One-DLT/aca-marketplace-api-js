...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CostSharingReductionEnum', 'model/FamilyCostEnum', 'model/NetworkTierEnum'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CostSharingReductionEnum'), require('./FamilyCostEnum'), require('./NetworkTierEnum'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.Deductible = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.CostSharingReductionEnum, root.MarketplaceApi.FamilyCostEnum, root.MarketplaceApi.NetworkTierEnum);
  }
}(this, function(ApiClient, CostSharingReductionEnum, FamilyCostEnum, NetworkTierEnum) {
  'use strict';

  /**
   * The Deductible model module.
   * @module model/Deductible
   * @version 1
   */

  /**
   * Constructs a new <code>Deductible</code>.
   * @alias module:model/Deductible
   * @class
   */
  ...
  /**
   * Constructs a <code>Deductible</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Deductible} obj Optional instance to populate.
   * @return {module:model/Deductible} The populated <code>Deductible</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('family_cost'))
        obj.familyCost = FamilyCostEnum.constructFromObject(data['family_cost']);
  ...
  /**
   * @member {module:model/FamilyCostEnum} familyCost
   */
  ...
  /**
   * @member {module:model/Deductible.TypeEnum} type
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "Medical EHB Deductible"
     * @const
     */
    medicalEHBDeductible: "Medical EHB Deductible",

    /**
     * value: "Combined Medical and Drug EHB Deductible"
     * @const
     */
    combinedMedicalAndDrugEHBDeductible: "Combined Medical and Drug EHB Deductible",

    /**
     * value: "Drug EHB Deductible"
     * @const
     */
    drugEHBDeductible: "Drug EHB Deductible"
  };
