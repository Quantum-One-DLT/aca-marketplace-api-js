...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MarketplaceModelEnum'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MarketplaceModelEnum'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.State = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.MarketplaceModelEnum);
  }
}(this, function(ApiClient, MarketplaceModelEnum) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hix_name'))
        obj.hixName = ApiClient.convertToType(data['hix_name'], 'String');
      if (data.hasOwnProperty('hix_url'))
        obj.hixUrl = ApiClient.convertToType(data['hix_url'], 'String');
      if (data.hasOwnProperty('marketplace'))
        obj.marketplace = MarketplaceModelEnum.constructFromObject(data['marketplace']);
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('shop_hix_name'))
        obj.shopHixName = ApiClient.convertToType(data['shop_hix_name'], 'String');
      if (data.hasOwnProperty('shop_hix_url'))
        obj.shopHixUrl = ApiClient.convertToType(data['shop_hix_url'], 'String');
      if (data.hasOwnProperty('shop_marketplace'))
        obj.shopMarketplace = MarketplaceModelEnum.constructFromObject(data['shop_marketplace']);
      if (data.hasOwnProperty('8962_link'))
        obj._8962Link = ApiClient.convertToType(data['8962_link'], 'String');
      if (data.hasOwnProperty('8965_link'))
        obj._8965Link = ApiClient.convertToType(data['8965_link'], 'String');
      if (data.hasOwnProperty('assister_program_url'))
        obj.assisterProgramUrl = ApiClient.convertToType(data['assister_program_url'], 'String');
    }
    return obj;
  }
   ...
   * @member {String} fips
   */
  exports.prototype.fips = undefined;

  /**
   * @member {String} hixName
   */
  exports.prototype.hixName = undefined;

  /**
   * @member {String} hixUrl
   */
  exports.prototype.hixUrl = undefined;

  /**
   * @member {module:model/MarketplaceModelEnum} marketplace
   */
  ...
  /**
   * @member {String} shopHixName
   */
  exports.prototype.shopHixName = undefined;

  /**
   * @member {String} shopHixUrl
   */
  exports.prototype.shopHixUrl = undefined;

  /**
   * @member {module:model/MarketplaceModelEnum} shopMarketplace
   */
  exports.prototype.shopMarketplace = undefined;

  /**
   * @member {String} _8962Link
   */
  exports.prototype._8962Link = undefined;

  /**
   * @member {String} _8965Link
   */
  exports.prototype._8965Link = undefined;

  /**
   * @member {String} assisterProgramUrl
   */
  exports.prototype.assisterProgramUrl = undefined;
