...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LowIncomeChild'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LowIncomeChild'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.StateMedicaid = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.LowIncomeChild);
  }
}(this, function(ApiClient, LowIncomeChild) {
  'use strict';

  /**
   * The StateMedicaid model module.
   * @module model/StateMedicaid
   * @version 1
   */

  /**
   * Constructs a new <code>StateMedicaid</code>.
   * @alias module:model/StateMedicaid
   * @class
   */
  ...
  /**
   * Constructs a <code>StateMedicaid</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StateMedicaid} obj Optional instance to populate.
   * @return {module:model/StateMedicaid} The populated <code>StateMedicaid</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fiscal_quarter'))
        obj.fiscalQuarter = ApiClient.convertToType(data['fiscal_quarter'], 'Number');
      if (data.hasOwnProperty('pc_fpl_parent'))
        obj.pcFplParent = ApiClient.convertToType(data['pc_fpl_parent'], 'Number');
      if (data.hasOwnProperty('pc_fpl_pregnant'))
        obj.pcFplPregnant = ApiClient.convertToType(data['pc_fpl_pregnant'], 'Number');
      if (data.hasOwnProperty('pc_fpl_adult'))
        obj.pcFplAdult = ApiClient.convertToType(data['pc_fpl_adult'], 'Number');
      if (data.hasOwnProperty('pc_fpl_child_newborn'))
        obj.pcFplChildNewborn = ApiClient.convertToType(data['pc_fpl_child_newborn'], 'Number');
      if (data.hasOwnProperty('pc_fpl_child_1_5'))
        obj.pcFplChild15 = ApiClient.convertToType(data['pc_fpl_child_1_5'], 'Number');
      if (data.hasOwnProperty('pc_fpl_child_6_18'))
        obj.pcFplChild618 = ApiClient.convertToType(data['pc_fpl_child_6_18'], 'Number');
      if (data.hasOwnProperty('low_income_child'))
        obj.lowIncomeChild = ApiClient.convertToType(data['low_income_child'], [LowIncomeChild]);
      if (data.hasOwnProperty('chip'))
        obj.chip = ApiClient.convertToType(data['chip'], [LowIncomeChild]);
    }
    return obj;
  }
   ...
   */
  exports.prototype.abbrev = undefined;

  /**
   * 4 digit fiscal year
   * @member {Number} fiscalYear
   */
  exports.prototype.fiscalYear = undefined;

  /**
   * Fiscal quarter (1 - 4)
   * @member {Number} fiscalQuarter
   */
  exports.prototype.fiscalQuarter = undefined;

  /**
   * Percentage federal poverty level parent caretaker
   * @member {Number} pcFplParent
   */
  exports.prototype.pcFplParent = undefined;

  /**
   * Percentage medicaid federal poverty level pregnant woman
   * @member {Number} pcFplPregnant
   */
  exports.prototype.pcFplPregnant = undefined;

  /**
   * Percentage federal poverty level adult group
   * @member {Number} pcFplAdult
   */
  exports.prototype.pcFplAdult = undefined;

  /**
   * Percentage medicaid federal poverty level child
   * @member {Number} pcFplChildNewborn
   */
  exports.prototype.pcFplChildNewborn = undefined;

  /**
   * Percentage medicaid federal poverty level child 1 - 5
   * @member {Number} pcFplChild15
   */
  exports.prototype.pcFplChild15 = undefined;

  /**
   * Percentage medicaid federal poverty level child 6 - 18
   * @member {Number} pcFplChild618
   */
  exports.prototype.pcFplChild618 = undefined;

  /**
   * Low income child eligibility rules
   * @member {Array.<module:model/LowIncomeChild>} lowIncomeChild
   */
  exports.prototype.lowIncomeChild = undefined;

  /**
   * Children's Health Insurance Program eligibility rules
   * @member {Array.<module:model/LowIncomeChild>} chip
   */
