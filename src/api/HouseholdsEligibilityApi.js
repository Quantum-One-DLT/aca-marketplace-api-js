...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Estimate', 'model/ICHRAResponse', 'model/Ichra', 'model/InlineResponse2005', 'model/InlineResponse2006', 'model/Lcbp', 'model/Lcsp', 'model/LowestCostPlanResponse', 'model/Slcsp'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Estimate'), require('../model/ICHRAResponse'), require('../model/Ichra'), require('../model/InlineResponse2005'), require('../model/InlineResponse2006'), require('../model/Lcbp'), require('../model/Lcsp'), require('../model/LowestCostPlanResponse'), require('../model/Slcsp'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.HouseholdsEligibilityApi = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.Estimate, root.MarketplaceApi.ICHRAResponse, root.MarketplaceApi.Ichra, root.MarketplaceApi.InlineResponse2005, root.MarketplaceApi.InlineResponse2006, root.MarketplaceApi.Lcbp, root.MarketplaceApi.Lcsp, root.MarketplaceApi.LowestCostPlanResponse, root.MarketplaceApi.Slcsp);
  }
}(this, function(ApiClient, Estimate, ICHRAResponse, Ichra, InlineResponse2005, InlineResponse2006, Lcbp, Lcsp, LowestCostPlanResponse, Slcsp) {
  'use strict';

  /**
   * HouseholdsEligibility service.
   * @module api/HouseholdsEligibilityApi
   * @version 1
   */

  /**
   * Constructs a new HouseholdsEligibilityApi. 
   * @alias module:api/HouseholdsEligibilityApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the householdsEligibilityEstimatesPost operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsEligibilityEstimatesPostCallback
     ...
     * @param {module:model/Estimate} estimate eligibility estimate request object
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/HouseholdsEligibilityApi~householdsEligibilityEstimatesPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2005}
     */
    this.householdsEligibilityEstimatesPost = function(apikey, estimate, opts, callback) {
      opts = opts || {};
      var postBody = estimate;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsEligibilityEstimatesPost");
      }

      // verify the required parameter 'estimate' is set
      if (estimate === undefined || estimate === null) {
        throw new Error("Missing the required parameter 'estimate' when calling householdsEligibilityEstimatesPost");
      }
      ...
      return this.apiClient.callApi(
        '/households/eligibility/estimates', 'POST',
    ...
    /**
     * Callback function to receive the result of the householdsIchraPost operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsIchraPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ICHRAResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/Ichra} ichra ichra request object
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/HouseholdsEligibilityApi~householdsIchraPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ICHRAResponse}
     */
    this.householdsIchraPost = function(apikey, ichra, opts, callback) {
      opts = opts || {};
      var postBody = ichra;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsIchraPost");
      }

      // verify the required parameter 'ichra' is set
      if (ichra === undefined || ichra === null) {
        throw new Error("Missing the required parameter 'ichra' when calling householdsIchraPost");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = ICHRAResponse;

      return this.apiClient.callApi(
        '/households/ichra', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the householdsLcbpPost operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsLcbpPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LowestCostPlanResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/Lcbp} lcbp lcbp request object
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/HouseholdsEligibilityApi~householdsLcbpPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LowestCostPlanResponse}
     */
    this.householdsLcbpPost = function(apikey, lcbp, opts, callback) {
      opts = opts || {};
      var postBody = lcbp;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsLcbpPost");
      }

      // verify the required parameter 'lcbp' is set
      if (lcbp === undefined || lcbp === null) {
        throw new Error("Missing the required parameter 'lcbp' when calling householdsLcbpPost");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = LowestCostPlanResponse;

      return this.apiClient.callApi(
        '/households/lcbp', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the householdsLcspPost operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsLcspPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LowestCostPlanResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/Lcsp} lcsp lcsp request object
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/HouseholdsEligibilityApi~householdsLcspPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LowestCostPlanResponse}
     */
    this.householdsLcspPost = function(apikey, lcsp, opts, callback) {
      opts = opts || {};
      var postBody = lcsp;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsLcspPost");
      }

      // verify the required parameter 'lcsp' is set
      if (lcsp === undefined || lcsp === null) {
        throw new Error("Missing the required parameter 'lcsp' when calling householdsLcspPost");
      }
    ...
    /**
     * Callback function to receive the result of the householdsPcfplGet operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsPcfplGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apikey API key used for authentication
     * @param {Number} year 4 digit market year.
     * @param {String} state 2-letter USPS state abbreviation, uppercased.
     * @param {Number} size Total size of household
     * @param {Number} income Household Income
     * @param {module:api/HouseholdsEligibilityApi~householdsPcfplGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2006}
     */
    this.householdsPcfplGet = function(apikey, year, state, size, income, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsPcfplGet");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling householdsPcfplGet");
      }

      // verify the required parameter 'state' is set
      if (state === undefined || state === null) {
        throw new Error("Missing the required parameter 'state' when calling householdsPcfplGet");
      }

      // verify the required parameter 'size' is set
      if (size === undefined || size === null) {
        throw new Error("Missing the required parameter 'size' when calling householdsPcfplGet");
      }

      // verify the required parameter 'income' is set
      if (income === undefined || income === null) {
        throw new Error("Missing the required parameter 'income' when calling householdsPcfplGet");
      }
    ...
    /**
     * Callback function to receive the result of the householdsSlcspPost operation.
     * @callback module:api/HouseholdsEligibilityApi~householdsSlcspPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/LowestCostPlanResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/Slcsp} slcsp slcsp request object
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/HouseholdsEligibilityApi~householdsSlcspPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/LowestCostPlanResponse}
     */
    this.householdsSlcspPost = function(apikey, slcsp, opts, callback) {
      opts = opts || {};
      var postBody = slcsp;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling householdsSlcspPost");
      }

      // verify the required parameter 'slcsp' is set
      if (slcsp === undefined || slcsp === null) {
        throw new Error("Missing the required parameter 'slcsp' when calling householdsSlcspPost");
      }
