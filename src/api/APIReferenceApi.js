...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataVersion', 'model/MarketYears'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DataVersion'), require('../model/MarketYears'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.APIReferenceApi = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.DataVersion, root.MarketplaceApi.MarketYears);
  }
}(this, function(ApiClient, DataVersion, MarketYears) {
  'use strict';

  /**
   * APIReference service.
   * @module api/APIReferenceApi
   * @version 1
   */

  /**
   * Constructs a new APIReferenceApi. 
   * @alias module:api/APIReferenceApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the marketYearsGet operation.
     * @callback module:api/APIReferenceApi~marketYearsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/MarketYears} data The data returned by the service call.
     ...
     * @param {module:api/APIReferenceApi~marketYearsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/MarketYears}
     */
    this.marketYearsGet = function(apikey, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling marketYearsGet");
      }
     ...
     * @callback module:api/APIReferenceApi~versionsGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/DataVersion>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:api/APIReferenceApi~versionsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/DataVersion>}
     */
    this.versionsGet = function(apikey, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling versionsGet");
      }
