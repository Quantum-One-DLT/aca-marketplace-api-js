...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2001', 'model/InlineResponse20010', 'model/InlineResponse20011', 'model/InlineResponse20012', 'model/InlineResponse20014', 'model/InlineResponse2009', 'model/PlanSearchRequest', 'model/Request'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2001'), require('../model/InlineResponse20010'), require('../model/InlineResponse20011'), require('../model/InlineResponse20012'), require('../model/InlineResponse20014'), require('../model/InlineResponse2009'), require('../model/PlanSearchRequest'), require('../model/Request'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.InsurancePlansApi = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.InlineResponse2001, root.MarketplaceApi.InlineResponse20010, root.MarketplaceApi.InlineResponse20011, root.MarketplaceApi.InlineResponse20012, root.MarketplaceApi.InlineResponse20014, root.MarketplaceApi.InlineResponse2009, root.MarketplaceApi.PlanSearchRequest, root.MarketplaceApi.Request);
  }
}(this, function(ApiClient, InlineResponse2001, InlineResponse20010, InlineResponse20011, InlineResponse20012, InlineResponse20014, InlineResponse2009, PlanSearchRequest, Request) {
  'use strict';

  /**
   * InsurancePlans service.
   * @module api/InsurancePlansApi
   * @version 1
   */

  /**
   * Constructs a new InsurancePlansApi. 
   * @alias module:api/InsurancePlansApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the crosswalkGet operation.
     * @callback module:api/InsurancePlansApi~crosswalkGetCallback
     ...
     * @param {Number} year Previous year
     * @param {String} planId Previous year plan ID
     * @param {String} state State abbreviation
     * @param {String} zipcode ZIP Code
     * @param {String} fips FIPS code
     * @param {module:api/InsurancePlansApi~crosswalkGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2001}
     */
    this.crosswalkGet = function(apikey, year, planId, state, zipcode, fips, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling crosswalkGet");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling crosswalkGet");
      }

      // verify the required parameter 'planId' is set
      if (planId === undefined || planId === null) {
        throw new Error("Missing the required parameter 'planId' when calling crosswalkGet");
      }

      // verify the required parameter 'state' is set
      if (state === undefined || state === null) {
        throw new Error("Missing the required parameter 'state' when calling crosswalkGet");
      }

      // verify the required parameter 'zipcode' is set
      if (zipcode === undefined || zipcode === null) {
        throw new Error("Missing the required parameter 'zipcode' when calling crosswalkGet");
      }

      // verify the required parameter 'fips' is set
      if (fips === undefined || fips === null) {
        throw new Error("Missing the required parameter 'fips' when calling crosswalkGet");
      }
     ...
     * @callback module:api/InsurancePlansApi~plansPlanIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apikey API key used for authentication
     * @param {String} planId 14-character HIOS plan ID
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/InsurancePlansApi~plansPlanIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20012}
     */
    this.plansPlanIdGet = function(apikey, planId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling plansPlanIdGet");
      }
    ...
    /**
     * Callback function to receive the result of the plansPlanIdQualityRatingsGet operation.
     * @callback module:api/InsurancePlansApi~plansPlanIdQualityRatingsGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/InsurancePlansApi~plansPlanIdQualityRatingsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20014}
     */
    this.plansPlanIdQualityRatingsGet = function(apikey, year, planId, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling plansPlanIdQualityRatingsGet");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling plansPlanIdQualityRatingsGet");
      }

      // verify the required parameter 'planId' is set
      if (planId === undefined || planId === null) {
        throw new Error("Missing the required parameter 'planId' when calling plansPlanIdQualityRatingsGet");
      }
      ...
      return this.apiClient.callApi(
        '/plans/{plan_id}/quality-ratings', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:api/InsurancePlansApi~plansPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/InsurancePlansApi~plansPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2009}
     */
    this.plansPost = function(apikey, request, opts, callback) {
      opts = opts || {};
      var postBody = request;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling plansPost");
      }

      // verify the required parameter 'request' is set
      if (request === undefined || request === null) {
        throw new Error("Missing the required parameter 'request' when calling plansPost");
      }
    ...
    /**
     * Callback function to receive the result of the plansSearchPost operation.
     * @callback module:api/InsurancePlansApi~plansSearchPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/PlanSearchRequest} body 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/InsurancePlansApi~plansSearchPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20010}
     */
    this.plansSearchPost = function(apikey, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling plansSearchPost");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling plansSearchPost");
      }
    ...
    /**
     * Callback function to receive the result of the plansSearchStatsPost operation.
     * @callback module:api/InsurancePlansApi~plansSearchStatsPostCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apikey API key used for authentication
     * @param {module:model/PlanSearchRequest} search 
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/InsurancePlansApi~plansSearchStatsPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/InlineResponse20011>}
     */
    this.plansSearchStatsPost = function(apikey, search, opts, callback) {
      opts = opts || {};
      var postBody = search;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling plansSearchStatsPost");
      }

      // verify the required parameter 'search' is set
      if (search === undefined || search === null) {
        throw new Error("Missing the required parameter 'search' when calling plansSearchStatsPost");
      }
