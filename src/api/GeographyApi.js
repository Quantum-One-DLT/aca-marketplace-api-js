...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/County', 'model/InlineResponse200', 'model/InlineResponse20019', 'model/PovertyGuideline', 'model/RateArea', 'model/State', 'model/StateMedicaid'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/County'), require('../model/InlineResponse200'), require('../model/InlineResponse20019'), require('../model/PovertyGuideline'), require('../model/RateArea'), require('../model/State'), require('../model/StateMedicaid'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.GeographyApi = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.County, root.MarketplaceApi.InlineResponse200, root.MarketplaceApi.InlineResponse20019, root.MarketplaceApi.PovertyGuideline, root.MarketplaceApi.RateArea, root.MarketplaceApi.State, root.MarketplaceApi.StateMedicaid);
  }
}(this, function(ApiClient, County, InlineResponse200, InlineResponse20019, PovertyGuideline, RateArea, State, StateMedicaid) {
  'use strict';

  /**
   * Geography service.
   * @module api/GeographyApi
   * @version 1
   */

  /**
   * Constructs a new GeographyApi. 
   * @alias module:api/GeographyApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the countiesByZipZipcodeGet operation.
     * @callback module:api/GeographyApi~countiesByZipZipcodeGetCallback
     ...
     * @param {String} zipcode 5 digit ZIP Code or 1-4 digit prefix of a ZIP Code
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/GeographyApi~countiesByZipZipcodeGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse200}
     */
    this.countiesByZipZipcodeGet = function(apikey, zipcode, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling countiesByZipZipcodeGet");
      }

      // verify the required parameter 'zipcode' is set
      if (zipcode === undefined || zipcode === null) {
        throw new Error("Missing the required parameter 'zipcode' when calling countiesByZipZipcodeGet");
      }
    ...
    /**
     * Callback function to receive the result of the countiesFipsGet operation.
     * @callback module:api/GeographyApi~countiesFipsGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/County} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/GeographyApi~countiesFipsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/County}
     */
    this.countiesFipsGet = function(apikey, fips, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling countiesFipsGet");
      }

      // verify the required parameter 'fips' is set
      if (fips === undefined || fips === null) {
        throw new Error("Missing the required parameter 'fips' when calling countiesFipsGet");
      }
    ...
    /**
     * Callback function to receive the result of the rateAreasGet operation.
     * @callback module:api/GeographyApi~rateAreasGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/RateArea} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} apikey API key used for authentication
     * @param {String} state 2-letter USPS state abbreviation
     * @param {Number} fips 5-digit county FIPS code
     * @param {Number} zipcode 5-digit ZIP Code
     * @param {Number} year 4 digit market year.
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.market Insurance market (default to Individual)
     * @param {module:api/GeographyApi~rateAreasGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/RateArea}
     */
    this.rateAreasGet = function(apikey, state, fips, zipcode, year, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling rateAreasGet");
      }

      // verify the required parameter 'state' is set
      if (state === undefined || state === null) {
        throw new Error("Missing the required parameter 'state' when calling rateAreasGet");
      }

      // verify the required parameter 'fips' is set
      if (fips === undefined || fips === null) {
        throw new Error("Missing the required parameter 'fips' when calling rateAreasGet");
      }

      // verify the required parameter 'zipcode' is set
      if (zipcode === undefined || zipcode === null) {
        throw new Error("Missing the required parameter 'zipcode' when calling rateAreasGet");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling rateAreasGet");
      }
    ...
    /**
     * Callback function to receive the result of the statesAbbrevGet operation.
     * @callback module:api/GeographyApi~statesAbbrevGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} apikey API key used for authentication
     * @param {String} abbrev 2-letter USPS state abbreviation, uppercased.
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/GeographyApi~statesAbbrevGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/State}
     */
    this.statesAbbrevGet = function(apikey, abbrev, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling statesAbbrevGet");
      }

      // verify the required parameter 'abbrev' is set
      if (abbrev === undefined || abbrev === null) {
        throw new Error("Missing the required parameter 'abbrev' when calling statesAbbrevGet");
      }
    ...
    /**
     * Callback function to receive the result of the statesAbbrevMedicaidGet operation.
     * @callback module:api/GeographyApi~statesAbbrevMedicaidGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StateMedicaid} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {String} opts.quarter 1-4 A specific fiscal quarter. When not specified it defaults to the most current data for the specified year
     * @param {module:api/GeographyApi~statesAbbrevMedicaidGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StateMedicaid}
     */
    this.statesAbbrevMedicaidGet = function(apikey, abbrev, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling statesAbbrevMedicaidGet");
      }

      // verify the required parameter 'abbrev' is set
      if (abbrev === undefined || abbrev === null) {
        throw new Error("Missing the required parameter 'abbrev' when calling statesAbbrevMedicaidGet");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = StateMedicaid;

      return this.apiClient.callApi(
        '/states/{abbrev}/medicaid', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the statesAbbrevPovertyGuidelinesGet operation.
     * @callback module:api/GeographyApi~statesAbbrevPovertyGuidelinesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PovertyGuideline} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} abbrev 2-letter USPS state abbreviation, uppercased.
     * @param {Number} year 4 digit market year.
     * @param {module:api/GeographyApi~statesAbbrevPovertyGuidelinesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PovertyGuideline}
     */
    this.statesAbbrevPovertyGuidelinesGet = function(apikey, abbrev, year, callback) {
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling statesAbbrevPovertyGuidelinesGet");
      }

      // verify the required parameter 'abbrev' is set
      if (abbrev === undefined || abbrev === null) {
        throw new Error("Missing the required parameter 'abbrev' when calling statesAbbrevPovertyGuidelinesGet");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling statesAbbrevPovertyGuidelinesGet");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = PovertyGuideline;

      return this.apiClient.callApi(
        '/states/{abbrev}/poverty-guidelines', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the statesGet operation.
     * @callback module:api/GeographyApi~statesGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/GeographyApi~statesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20019}
     */
    this.statesGet = function(apikey, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling statesGet");
      }
