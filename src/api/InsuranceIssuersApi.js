...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2007', 'model/InlineResponse2008'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2007'), require('../model/InlineResponse2008'));
  } else {
    // Browser globals (root is window)
    if (!root.MarketplaceApi) {
      root.MarketplaceApi = {};
    }
    root.MarketplaceApi.InsuranceIssuersApi = factory(root.MarketplaceApi.ApiClient, root.MarketplaceApi.InlineResponse2007, root.MarketplaceApi.InlineResponse2008);
  }
}(this, function(ApiClient, InlineResponse2007, InlineResponse2008) {
  'use strict';

  /**
   * InsuranceIssuers service.
   * @module api/InsuranceIssuersApi
   * @version 1
   */

  /**
   * Constructs a new InsuranceIssuersApi. 
   * @alias module:api/InsuranceIssuersApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the issuersGet operation.
     * @callback module:api/InsuranceIssuersApi~issuersGetCallback
     ...
     * @param {String} opts.state 2-letter USPS state abbreviation
     * @param {Number} opts.limit  (default to 25)
     * @param {Number} opts.offset  (default to 0)
     * @param {module:api/InsuranceIssuersApi~issuersGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2007}
     */
    this.issuersGet = function(apikey, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling issuersGet");
      }
    ...
    /**
     * Callback function to receive the result of the issuersIssuerIdGet operation.
     * @callback module:api/InsuranceIssuersApi~issuersIssuerIdGetCallback
     * @param {String} error Error message, if any.
     ...
     * Get issuer
     * @param {String} apikey API key used for authentication
     * @param {String} issuerId 5-digit HIOS issuer ID
     * @param {Object} opts Optional parameters
     * @param {Number} opts.year 4 digit market year (Defaults to the current year when not specified).
     * @param {module:api/InsuranceIssuersApi~issuersIssuerIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2008}
     */
    this.issuersIssuerIdGet = function(apikey, issuerId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'apikey' is set
      if (apikey === undefined || apikey === null) {
        throw new Error("Missing the required parameter 'apikey' when calling issuersIssuerIdGet");
      }

      // verify the required parameter 'issuerId' is set
      if (issuerId === undefined || issuerId === null) {
        throw new Error("Missing the required parameter 'issuerId' when calling issuersIssuerIdGet");
      }
